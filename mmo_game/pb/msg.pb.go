...
type Position struct {
	...
	X float32 `protobuf:"fixed32,1,opt,name=X,proto3" json:"X,omitempty"` //平面x坐标
	Y float32 `protobuf:"fixed32,2,opt,name=Y,proto3" json:"Y,omitempty"` //高度
	Z float32 `protobuf:"fixed32,3,opt,name=Z,proto3" json:"Z,omitempty"` //平面y坐标 (注意不是Y)
	V float32 `protobuf:"fixed32,4,opt,name=V,proto3" json:"V,omitempty"` //旋转0-360度
}
...
type BroadCast struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` // 广播消息发起者
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"`   //广播消息类型 1~世界聊天 2~玩家出生点位置 3~动作 4~移动之后坐标信息更新
